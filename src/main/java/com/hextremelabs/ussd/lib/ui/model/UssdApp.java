...
// Generated on: 2016.08.08 at 01:36:35 AM WAT
//
 ...
 *       &lt;attribute name="commandOpener" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="commandSeparator" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="commandTerminator" type="{http://www.w3.org/2001/XMLSchema}string" />
...
public class UssdApp {
  ...
  @XmlAttribute(name = "commandOpener")
  protected String commandOpener;
  @XmlAttribute(name = "commandSeparator")
  protected String commandSeparator;
  @XmlAttribute(name = "commandTerminator")
  protected String commandTerminator;
  ...
  /**
   * Gets the value of the commandOpener property.
   *
   * @return possible object is {@link String }
   *
   */
  public String getCommandOpener() {
    return commandOpener;
  }

  /**
   * Sets the value of the commandOpener property.
   *
   * @param value allowed object is {@link String }
   *
   */
  public void setCommandOpener(String value) {
    this.commandOpener = value;
  }

  /**
   * Gets the value of the commandSeparator property.
   *
   * @return possible object is {@link String }
   *
   */
  ...
  /**
   * Sets the value of the commandSeparator property.
   *
   * @param value allowed object is {@link String }
   *
   */
  public void setCommandSeparator(String value) {
    this.commandSeparator = value;
  }

  /**
   * Gets the value of the commandTerminator property.
   *
   * @return possible object is {@link String }
   *
   */
  ...
  /**
   * Sets the value of the commandTerminator property.
   *
   * @param value allowed object is {@link String }
   *
   */
  public void setCommandTerminator(String value) {
    this.commandTerminator = value;
  }
